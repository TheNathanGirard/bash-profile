...
setup_directories() {
    ...
    print_colored "$YELLOW" "Cloning bash-profile repository into: $LINUXTOOLBOXDIR/mybash"
    if git clone https://github.com/TheNathanGirard/bash-profile "$LINUXTOOLBOXDIR/mybash"; then
